...
exports.DEBUG_WASM = node_fs_1.default.readFileSync(path_1.default.join(__dirname, "..", "..", "build", "debug.wasm"));
const log = (obj) => {
...
const buildProgram = () => {
    const program = new metashrew_test_1.IndexerProgram(new Uint8Array(Array.from(exports.DEBUG_WASM)).buffer);
