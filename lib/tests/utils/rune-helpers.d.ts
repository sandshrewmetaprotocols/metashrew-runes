...
export declare const initCompleteBlockWithRuneEtching: (outputs: any, pointer: number, divisibility?: number, premineAmount?: bigint, runeName?: string, symbol?: string, block?: bitcoinjs.Block, skipTx?: number) => bitcoinjs.Block;
